                ...
                <div class="row">
                            <div class="card bg-success text-white ml-4 " style="width: 18rem;">
                                <div class="card-body">
                                    ...
                                    <a href="data_siswa.php"><p class="card-text text-white"><i class="fas ml-2 fa-angle-double-right"></i> Lihat Detail</p></a>
                                </div>
                            </div>
                            <div class="card bg-danger text-white ml-4 " style="width: 18rem;">
                                <div class="card-body">
                                    <div class="card-body-icon">
                                    ...
                                    <div class="display-4">
                                        <?php  
                                            include 'koneksi.php';
                                            $data = mysqli_query($koneksi,"SELECT COUNT(*) as num FROM petugas WHERE level='petugas'");
                                                $data = mysqli_fetch_assoc($data);
                                                $jml = $data['num'];
                                                echo $jml;
                                            ?>
                                    </div>
                                    <a href="data_petugas.php"><p class="card-text text-white"><i class="fas ml-2 fa-angle-double-right"></i> Lihat Detail</p></a>
                                </div>
                            </div>
                            ...
                            <div class="card bg-primary text-white ml-4 mt-4" style="width: 18rem;">
                                <div class="card-body">
                                    <div class="card-body-icon">
