<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
        ...
        <form id="cari" class="form-inline my-2 my-lg-0 ml-auto" action="" method="POST">
            <input class="form-control mr-sm-2" name="cari" type="search" placeholder="Cari ID" name="cari" style="width: 400px">
