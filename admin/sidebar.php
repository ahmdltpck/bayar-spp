<ul class="nav flex-column mb-5 ml-1 ">
                <div class="profil ml-5 ">
                    <h4><i class="fas fa-user-edit text-white display-4"></i><p class="text-white">Admin</p></h4>
                </div>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="data_petugas.php"><i class="mr-2 fas fa-chalkboard-teacher"></i>Data Petugas</a><hr class="bg-secondary">
                </li>
                <li class="nav-item">
